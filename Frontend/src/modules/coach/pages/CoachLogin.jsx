...
const CoachLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFF1F1] md:bg-[#F8FAFC] flex items-center justify-center px-6 relative overflow-hidden font-sans">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[400px] h-[400px] bg-[#eb483f]/5 rounded-full blur-[100px]" />
      ...
      >
        <div className="space-y-8">
          <div className="text-center">
            {/* Coach Label */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#eb483f]/10 border border-[#eb483f]/20 mb-4">
               <span className="text-[10px] font-black text-[#eb483f] uppercase tracking-widest">Official Coach Entry</span>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-right">
              <button type="button" className="text-[#eb483f] font-black text-[10px] uppercase tracking-widest hover:underline decoration-2 underline-offset-4 transition-all">Forgot Passkey?</button>
            </div>
            ...
            <Button
              ...
              size="large"
              disabled={isLoading}
              className="bg-[#eb483f] hover:bg-[#1a2b3c] py-4 shadow-2xl shadow-[#eb483f]/20 active:scale-95 transition-all"
              sx={{
                borderRadius: '18px',
                textTransform: 'none',
                fontSize: '0.9rem',
          ...
          <div className="text-center space-y-4 pt-4 border-t border-slate-50">
             <p className="text-[11px] text-slate-500 font-bold uppercase tracking-wider">
               New to coaching? {' '}
               <button onClick={() => navigate('/coach/signup')} className="text-[#eb483f] font-black underline underline-offset-4">Join Panel</button>
             </p>
