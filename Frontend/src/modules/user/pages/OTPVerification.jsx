  ...
  return (
    <div className="min-h-screen bg-[#FFF1F1] md:bg-white flex items-center justify-center px-6 relative overflow-hidden">
      ...
      >
        <button 
          onClick={() => navigate(-1)} 
          className="mb-8 w-11 h-11 rounded-full bg-white/80 border border-slate-100 flex items-center justify-center hover:bg-[#eb483f] hover:text-white transition-all shadow-sm active:scale-90"
        >
        ...
        <div className="space-y-10">
          <div className="text-center">
            <div className="w-24 h-24 bg-white/50 backdrop-blur-md rounded-[32px] mx-auto flex items-center justify-center shadow-xl shadow-[#eb483f]/10 border border-white/40">
               <Message className="text-[#eb483f]" sx={{ fontSize: 44 }} />
            </div>
          ...
          <div className="flex justify-center space-x-3 sm:space-x-4">
            {otp.map((digit, index) => (
              <input
                ...
                className="w-14 h-16 sm:w-16 sm:h-20 bg-white/70 border-2 border-slate-100 backdrop-blur-md rounded-2xl text-center text-3xl font-black text-[#0F172A] shadow-inner focus:border-[#eb483f] focus:bg-white focus:outline-none focus:ring-8 focus:ring-[#eb483f]/5 transition-all outline-none"
              />
            ))}
          </div>
          ...
          <div className="text-center">
            <p className="text-slate-500 font-medium">
              ...
              <button className="text-[#eb483f] font-bold hover:underline">Resend in 0:45</button>
            </p>
          </div>
          ...
          <Button
            ...
            variant="contained"
            size="large"
            className="bg-[#eb483f] hover:bg-[#eb483f]/90 py-4 shadow-xl shadow-[#eb483f]/30 active:scale-95 transition-all"
            sx={{ 
                borderRadius: '16px', 
                textTransform: 'none', 
                fontWeight: 'bold', 
