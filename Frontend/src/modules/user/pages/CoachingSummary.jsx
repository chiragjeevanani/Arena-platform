  ...
  return (
    <div className={`min-h-screen pb-40 relative overflow-hidden ${'bg-slate-50'}`}>
      ...
      <div className={`px-6 pt-5 pb-3 sticky top-0 z-[60] backdrop-blur-2xl border-b transition-all duration-500 ${
        'bg-[#0F172A] border-blue-900/10 md:rounded-b-none rounded-b-[24px] shadow-[0_15px_40px_rgba(15,23,42,0.25)]'
      }`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-7 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start text-center sm:text-left">
                <div className="relative">
                  <img 
                    ...
                    alt={batch.coachName} 
                  />
                  <div className="absolute -bottom-1 -right-1 bg-[#eb483f] text-[#eb483f] w-7 h-7 rounded-xl flex items-center justify-center border-3 border-white shadow-lg">
                ...
                <div className="flex-1">
                  ...
                  <h3 className={`text-xl md:text-2xl font-black font-display tracking-tight ${'text-[#0F172A]'}`}>
                    {batch.coachName}
                  </h3>
                  <p className={`text-xs font-bold font-display mt-0.5 ${'text-[#0F172A]/40'}`}>
                    Professional Academic Trainer
                  </p>
                  
                  <div className="grid grid-cols-2 gap-3 mt-4">
                    <div className={`p-2.5 rounded-xl border ${'bg-slate-50 border-slate-100'}`}>
                       <p className={`text-[7px] font-black uppercase tracking-widest ${'text-slate-400'}`}>Experience</p>
                       <p className={`text-[11px] font-bold mt-0.5 ${'text-[#eb483f]'}`}>8+ Years</p>
                    </div>
                    <div className={`p-2.5 rounded-xl border ${'bg-slate-50 border-slate-100'}`}>
                       <p className={`text-[7px] font-black uppercase tracking-widest ${'text-slate-400'}`}>Rating</p>
                       <p className={`text-[11px] font-bold mt-0.5 flex items-center gap-1 ${'text-[#eb483f]'}`}>
            ...
            <div className="space-y-3">
               <h4 className={`text-[10px] font-black uppercase tracking-[0.2em] ml-2 ${'text-[#eb483f]/40'}`}>Scheduled Training</h4>
               
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className={`p-6 rounded-[32px] border border-dashed transition-all hover:border-[#eb483f]/20 group ${'bg-white border-blue-100 shadow-sm shadow-blue-500/5'}`}>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className={`text-base font-black tracking-tight ${'text-[#eb483f]'}`}>{batch.days}</span>
                    </div>
                  </div>
                  <div className={`p-6 rounded-[32px] border border-dashed transition-all hover:border-[#eb483f]/20 group ${'bg-white border-emerald-100 shadow-sm shadow-emerald-500/5'}`}>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className={`text-base font-black tracking-tight ${'text-[#eb483f]'}`}>{batch.timing}</span>
                    </div>
                  </div>
               </div>
            </div>
          ...
          <div className="md:col-span-5 space-y-6">
            <div className="space-y-3">
               <h4 className={`text-[10px] font-black uppercase tracking-[0.2em] ml-2 ${'text-[#eb483f]/40'}`}>Subscription Fees</h4>
               
               <div className={`rounded-[36px] border relative overflow-hidden ${
                 'bg-white border-blue-50 shadow-2xl shadow-blue-500/5'
               }`}>
                  <div className="p-6 md:p-8 space-y-5">
                     <div className="flex justify-between items-center group">
                        <span className={`text-xs font-bold transition-colors ${isDark ? 'text-white/40 group-hover:text-white/60' : 'text-[#eb483f]/50'}`}>Monthly Coaching Fee</span>
                        <span className={`text-sm md:text-base font-black ${'text-[#eb483f]'}`}>â‚¹{monthlyFee.toFixed(2)}</span>
                     </div>
                     <div className="flex justify-between items-center group">
                        <span className={`text-xs font-bold transition-colors ${isDark ? 'text-white/40 group-hover:text-white/60' : 'text-[#eb483f]/50'}`}>One-time Registration</span>
                        <span className={`text-sm md:text-base font-black ${'text-[#eb483f]'}`}>â‚¹{regFee.toFixed(2)}</span>
                     </div>
                     <div className="flex justify-between items-center group">
                        <div className="flex items-center gap-2">
                          <span className={`text-xs font-bold transition-colors ${isDark ? 'text-white/40 group-hover:text-white/60' : 'text-[#eb483f]/50'}`}>GST Charges</span>
                          <span className="text-[9px] bg-slate-100 px-1.5 py-0.5 rounded text-slate-500 font-black">18%</span>
                        </div>
                        <span className={`text-sm md:text-base font-black ${'text-[#eb483f]'}`}>â‚¹{gst.toFixed(2)}</span>
                     </div>
                     ...
                     <div className={`mt-6 p-6 rounded-[32px] flex justify-between items-center relative overflow-hidden transition-all duration-500 ${
                       'bg-blue-600 shadow-xl shadow-blue-600/20'
                        ...
                        <div>
                           <p className={`text-[9px] font-black uppercase tracking-[0.3em] mb-1.5 ${'text-blue-100'}`}>Final Amount</p>
                  ...
                  <div className={`p-4 text-center border-t border-dashed ${'border-slate-100'}`}>
                    <div className="flex items-center justify-center gap-2.5 opacity-40">
                      ...
                      <span className={`text-[10px] font-black uppercase tracking-[0.2em] ${'text-[#eb483f]'}`}>Secured by ArenaPay</span>
                    </div>
                  </div>
               </div>
            </div>
            ...
            <div className={`hidden md:block p-6 rounded-[32px] border ${'bg-white border-blue-50 shadow-sm'}`}>
               <h5 className={`text-[10px] font-black uppercase tracking-widest mb-4 ${'text-[#eb483f]/50'}`}>Benefits & Policies</h5>
               <ul className="space-y-3">
                  {[
                    ...
                    <li key={i} className="flex gap-3 items-center">
                       ...
                       <span className={`text-[11px] font-bold ${'text-[#eb483f]/60'}`}>{text}</span>
                    </li>
                  ))}
               </ul>
            </div>
