    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
        <div className="flex items-center gap-4">
           ...
           <div>
              <h2 className="text-xl font-black tracking-tight text-[#1a2b3c]">Maintenance & Service</h2>
        ...
        <button 
          ...
          className="bg-[#eb483f] text-white px-6 py-3 rounded-xl font-black text-[11px] uppercase tracking-[0.2em] flex items-center gap-2 shadow-lg shadow-[#eb483f]/20 hover:scale-105 transition-all outline-none"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden flex flex-col">
           <div className="p-6 border-b border-slate-50 flex items-center justify-between">
              <h3 className="text-xs font-black uppercase tracking-[0.2em] text-[#1a2b3c]">Scheduled Works</h3>
           </div>
              ...
              <table className="w-full text-left">
                 <thead>
                    <tr className="bg-slate-50 border-b border-slate-100">
                       <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-[#1a2b3c]">Target Court</th>
                       <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-[#1a2b3c]">Task Details</th>
                       <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-[#1a2b3c]">Schedule</th>
                       ...
                       <tr key={task.id} className="hover:bg-slate-50/50 transition-all">
                          <td className="px-6 py-5">
                             <div className="flex items-center gap-2">
                                <span className="w-1.5 h-1.5 rounded-full bg-[#eb483f]" />
                                <span className="text-[11px] font-black text-[#1a2b3c] uppercase tracking-widest">{task.court}</span>
                             </div>
                          </td>
                          <td className="px-6 py-5">
                             <p className="text-sm font-black text-[#1a2b3c] mb-0.5">{task.task}</p>
                          ...
                          <td className="px-6 py-5">
                             <span className={`px-2.5 py-1.5 rounded-xl text-[9px] font-black uppercase border transition-all ${
                               ...
                               task.status === 'Routine' ? 'bg-[#1a2b3c]/5 text-[#1a2b3c] border-[#1a2b3c]/10' :
                          ...
                          <td className="px-6 py-5 text-right">
                             <button className="p-2 text-slate-300 hover:text-[#eb483f] transition-all"><MoreVertical size={14} /></button>
                          </td>
                       </tr>
                    ))}
                 </tbody>
        ...
        <div className="lg:col-span-4 space-y-6">
           <div className="bg-[#1a2b3c] p-6 rounded-3xl text-white relative overflow-hidden group">
              <div className="absolute top-0 right-0 p-6 opacity-10">
                 <AlertCircle size={100} />
              </div>
              <div className="relative z-10">
                 <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-[#eb483f] mb-6 underline underline-offset-8">Critical Alerts</h3>
                 <div className="space-y-4">
                    <div className="flex gap-4 p-4 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all cursor-pointer">
                       <AlertCircle size={20} className="text-[#eb483f] shrink-0" />
           ...
           <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100">
              <h3 className="text-xs font-black uppercase tracking-[0.2em] text-[#1a2b3c] mb-6">Staff Performance</h3>
              <div className="space-y-4">
                 {[
                   ...
                   <div key={i} className="flex items-center justify-between p-3 bg-white rounded-2xl shadow-sm border border-slate-100 transition-all hover:-translate-y-0.5">
                      <div className="flex items-center gap-3">
                         ...
                         <div>
                            <p className="text-[11px] font-black uppercase tracking-tight text-[#1a2b3c]">{staff.name}</p>
