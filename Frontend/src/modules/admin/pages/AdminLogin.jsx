      ...
      >
        <div className="space-y-5">
          ...
          <form onSubmit={handleLoginSubmit} className="space-y-4">
            ...
            {/* Password */}
            <div className="group">
              <label className="text-[9px] font-black uppercase tracking-widest text-slate-400 mb-1.5 block ml-1">Security Key</label>
              <div className="relative">
            ...
            >
              {isLoading ? (
                ...
                <>Enter Terminal <ArrowRight size={14} strokeWidth={2.5} /></>
              )}
            </motion.button>
          </form>
