...
function toPublicUser(doc) {
  ...
  return {
    ...
    profilePicture: doc.profilePicture || doc.avatarUrl || '',
    avatarUrl: doc.profilePicture || doc.avatarUrl || '',
    phone: doc.phone || '',
    address: doc.address || '',
    country: doc.country || '',
    location: doc.address && doc.country ? `${doc.address}, ${doc.country}` : (doc.location || doc.address || doc.country || ''),
